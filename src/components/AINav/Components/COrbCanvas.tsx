...
export interface COrbCanvasProps {
  hue?: number
...
function hexToVec3(color: string) {
  if (color === 'transparent') {
    return new Vec3(0, 0, 0) // Treat transparent as black for mix calculations, or handle logic differently
  }
